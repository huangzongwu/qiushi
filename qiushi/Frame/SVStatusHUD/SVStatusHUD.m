...
- (UIImageView *)imageView {
    if (imageView == nil) {
        imageView = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, 86, 86)];
    ...
    //??? 为什么会调用 两次
    if (imageView.image == [UIImage imageNamed:@"icon_shake.png"]) {
        [self addAnimations];
    }
...
-(void)addAnimations
{
    ...
    [imageView.layer addAnimation:translation forKey:@"translation"];
